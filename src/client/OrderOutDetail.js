...
class OrderOutDetail extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
            ...
            // auth: {
            //     header: localStorage.getItem("user_access_token"),
            // },
        };

        document.title = "Giden sargyt";
        this.setData();
    }
        ...
        return (
            <div className="p-2">
                ...
                <div className="grid border-b mb-2 ">
                    <label>Giden sargyt {this.state.products.length} </label>
                </div>
                ...
                <div className="grid text-[12px] border-y py-1 my-1">
                    ...
                    <lable>Salgysy: {this.state.address}</lable>
                    <lable>Bellik: {this.state.note}</lable>
                    <lable>
                        Eltip bermek hyzmaty: {this.state.delivery_price} TMT
                    </lable>
                    <lable>
                        ...
                        return (
                            ...
                            >
                                <img
                                    ...
                                    src={server + item.img}
                                ></img>
                                <div className="grid p-2 sm:text-[11px] content-start">
                ...
                <div className="flex justify-end items-center text-[14px]">
                    {this.state.status === "pending" && (
                        <button
                            ...
                            className="rounded-md p-1 bg-red-600 text-white flex items-center hover:bg-slate-400"
                        >
