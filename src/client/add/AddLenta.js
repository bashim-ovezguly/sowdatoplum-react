...
class AddLenta extends React.Component{
    ...
    save(){
        ...
        axios.post(server + '/mob/lenta' , formdata, {headers:{'token': token}}).then(resp=>{
            this.setState({isLoading:false})
            alert('Lenta üstünlikli goşuldy. Moderator tassyklamasyna garaşyň');
        }).catch(err=>{
            this.setState({isLoading:false})
    ...
    render(){
        ...
        return <div className="products add">
           ...
           <div className="grid">
                ...
                <textarea placeholder="Text" className="min-h-100px" id="text"></textarea>
                ...
                <button onClick={()=>{this.save()}} 
                    ...
                    <BiSave size={25} className="icon"></BiSave>
