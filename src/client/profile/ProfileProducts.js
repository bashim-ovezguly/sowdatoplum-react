                    ...
                    {this.state.products.map((item) => {
                        return (
                            <Link
                                ...
                                className="grid grid-rows-[max-content_auto] w-[140px] overflow-hidden m-[10px] 
                                        rounded shadow-md border hover:shadow-lg duration-300 text-[14px]"
                            >
                                {item.img === "" && (
                                    <img
                                        alt=""
