...
class PartEdit extends React.Component {
    ...
    delete() {
        ...
        if (result == true) {
            axios
                .post(server + "/mob/parts/delete/" + this.state.id)
                .then((resp) => {
                    window.history.back();
                });
        }
    ...
    addSelectedImages() {
        ...
        axios
            .put(server + "/mob/parts/" + this.state.id, formdata)
            .then((resp) => {
    ...
    removeImage(id) {
        if (window.confirm("Bozmaga ynamyňyz barmy?") == true)
            axios
                .post(server + "/mob/parts/img/delete/" + id)
                .then((resp) => {
                    this.setData();
                })
                .catch((err) => {
    ...
    render() {
        ...
        return (
            <div className="part_edit grid justify-center">
                <ToastContainer
                    autoClose={10000}
                    closeOnClick={true}
                ></ToastContainer>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-1">
                    ...
                    <div className="grid max-w-[400px] min-w-[300px] mx-auto text-[14px] h-max">
                        ...
                        <label className="font-boldfont-bold">
                            Ýerleşýän ýeri
                        </label>
                        ...
                        <div>
                            <button
                                ...
                                className="bg-green-600 m-1 text-white p-2 rounded-md"
                            >
                                Ýatda saklamak
                            </button>
                            <button
                                ...
                                className="bg-red-600 m-1 text-white p-2 rounded-md"
                            >
                                Bozmak
                            </button>
                        </div>
