...
class StoreCategories extends React.Component {
    ...
    setData() {
        axios
            .get(
                server +
                    "/api/admin/store_categories?page=" +
    ...
    deleteItem(id) {
        ...
        axios
            .delete(
                server + "/api/admin/store_categories/" + id,
                this.state.auth
            )
            .then((resp) => {
    ...
    editPromp(id, name) {
        ...
        axios
            .post(
                server + "/api/admin/store_categorie/" + id,
                fdata,
                this.state.auth
            )
            .then((resp) => {
    ...
    render() {
        return (
            <div className="grid">
                ...
                <div className="flex items-center text-white text-[12px] my-1">
                    <button
                        onClick={() => {
                            this.setState({ isLoading: true });
                            this.setData();
                        }}
                        className="p-1 bg-sky-700 flex items-center mx-1"
                    >
                        <MdRefresh></MdRefresh>
                        <label>Refresh</label>
                    </button>
                    ...
                    <button
                        className="p-1 bg-sky-700 text-white text-[12px] flex items-center mx-1"
                        onClick={() => {
