...
class AppVersions extends React.Component{
    ...
    delete(id){
        ...
        axios.delete(server + '/api/admin/apks/'+id, this.state.auth).then(resp=>{
    ...
    add(){
        ...
        axios.post(server + '/api/admin/apks/', fdata, this.state.auth).then(resp=>{
    ...
    render(){
        ...
        return <div className="app_versions">
         <h3>App Versions</h3>

            <div className="add">
                <input id="apk_file" type="file"></input>
                <input id="version" placeholder="Version" type="text"></input>
                <button onClick={()=>{this.add()}}>Ýatda sakla</button>
            </div>
            ...
            <div className="apk_items">
                {
                    this.state.apk_list.map(item=>{
                        return <div className="item">
                            ...
                            <MdDelete className="delete_icon" onClick={()=>{this.delete(item.id)}}></MdDelete>
